...
<div class="sidebar" id="sidebar">
    ...
    <ul>
        ...
        <li><a href="#" class="nav-link content-link" data-page="create_bhw.php"><i class="fas fa-user-plus"></i> <span>Create BHW Account</span></a></li>
        ...
        <li><a href="#" class="nav-link content-link" data-page="document_requests.php"><i class="fas fa-file-signature"></i> <span>Document Requests</span></a></li>
        <li><a href="#" class="nav-link content-link" data-page="settings.php"><i class="fas fa-cog"></i> <span>Settings</span></a></li>
...
<script>
    // Show toast notification for Admin after login
